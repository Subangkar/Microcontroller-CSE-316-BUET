...
main proc    
    ...
    @CONTINUE_SEARCH:
        ...
        @IFC: ; found
			...
			@LOOP_COUNT_TIMES_LEFT:
				DEC AX
				CMP AX,0
				JL @END_LOOP_COUNT_TIMES_LEFT:
                ...
                MOV BX,KEY
				CMP [DI],BX
				JNE @END_LOOP_COUNT_TIMES_LEFT
				INC CX
			JMP @LOOP_COUNT_TIMES_LEFT

			
			@END_LOOP_COUNT_TIMES_LEFT:
				MOV COUNT,CX
				MOV AX,POS_KEY
				
				MOV CX,0
			@LOOP_COUNT_TIMES_RIGHT:
				INC AX
				CMP AX,0
				JL @END_LOOP_COUNT_TIMES_RIGHT:
                ...
                MOV BX,KEY
				CMP [DI],BX
				JNE @END_LOOP_COUNT_TIMES_RIGHT
				INC CX
			JMP @LOOP_COUNT_TIMES_RIGHT
			
			@END_LOOP_COUNT_TIMES_RIGHT:
				ADD CX,COUNT
				INC CX
				MOV COUNT,CX
